...
public class EasyGoogleMobileAdsEditor : Editor {
	...
	private enum Item {
		...
		TAG_FOR_CHILD_DIRECTED_TREATMENT_HINT, ABOUT_TITLE
	}

	Dictionary<string, Dictionary<Item, string>> text = new Dictionary<string, Dictionary<Item, string>>
	{{
        bl_AdMod.Languages.English.ToString(), new Dictionary<Item, string> 
		{
        ...
        bl_AdMod.Languages.Español.ToString(), new Dictionary<Item, string>
		{
	...
	override public void OnInspectorGUI () {
		...
		editorLanguage.enumValueIndex = (int)(bl_AdMod.Languages)EditorGUILayout.EnumPopup(new GUIContent(getText(Item.LANGUAGE), getText(Item.LANGUAGE_HINT)), (bl_AdMod.Languages) Enum.Parse(typeof(bl_AdMod.Languages), editorLanguage.enumNames[editorLanguage.enumValueIndex]));
		...
		adSize.enumValueIndex = (int)(bl_AdMod.Sizes)EditorGUILayout.EnumPopup(new GUIContent(getText(Item.AD_SIZE), getText(Item.AD_SIZE_HINT)), (bl_AdMod.Sizes) Enum.Parse(typeof(bl_AdMod.Sizes), adSize.enumNames[adSize.enumValueIndex]));
		...
		tagForChildDirectedTreatment.enumValueIndex = (int)(bl_AdMod.TagForChildDirectedTreatment)EditorGUILayout.EnumPopup(new GUIContent(getText(Item.TAG_FOR_CHILD_DIRECTED_TREATMENT), getText(Item.TAG_FOR_CHILD_DIRECTED_TREATMENT_HINT)), (bl_AdMod.TagForChildDirectedTreatment) Enum.Parse(typeof(bl_AdMod.TagForChildDirectedTreatment), tagForChildDirectedTreatment.enumNames[tagForChildDirectedTreatment.enumValueIndex]));
